...
class CodeStandard extends Config
{
     ...
     */
    public function __construct(string $name = 'Nayleen', ?string $projectDirectory = null)
    {
        parent::__construct($name);

        $projectDirectory ??= $this->determineProjectDirectory();
        assert($projectDirectory !== '' && is_dir($projectDirectory));

        $this
            ->setParallelConfig(ParallelConfigFactory::detect())
            ->setFinder($this->createFinder($projectDirectory))
     ...
     */
    private function createFinder(string $projectDirectory): Finder
    {
    ...
    /**
     * Assume the file which called our constructor to be in the project root.
     * This is usually a .php-cs-fixer.php file or its dist equivalent.
     *
     * @return non-empty-string
     */
    private function determineProjectDirectory(): string
    {
